...
### Cash Flow page to track spending
<img width="1418" alt="track" src="https://github.com/RevoU-FSSE-2/week-7-gkorompis/assets/52250424/bfe21a0e-17fa-401e-bd26-28453566a3b2">

### Form to add new record
<img width="1416" alt="form" src="https://github.com/RevoU-FSSE-2/week-7-gkorompis/assets/52250424/a74d37e4-0792-4c86-96e3-e7c62fa1871c">

### List Records
<img width="1402" alt="listrecords" src="https://github.com/RevoU-FSSE-2/week-7-gkorompis/assets/52250424/646e1e2a-f126-40d4-a191-55ed3a3ac3d0">
...
To set up the project locally and compile the TypeScript files, follow these steps:

1. Clone the repository from GitHub:
```
git clone https://github.com/RevoU-FSSE-2/week-7-gkorompis
```
2. Navigate to the project folder:
```
cd week-7-gkorompis/src
```
3. Install the necessary dependencies:
```
npm install
```
4. Run the TypeScript compiler to transpile the source files to JavaScript:
```
npx tsc
```

The compiled JavaScript files will be outputted to the `dist` folder, as configured in the `tsconfig.json`.
